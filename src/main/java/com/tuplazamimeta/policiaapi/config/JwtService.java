...
public class JwtService {
    ...
    // CLAVE SECRETA (Debería estar en application.properties, pero para simplificar la ponemos aquí)
    // Es una clave aleatoria en Base64 de 256 bits.
    ...
    // 2. VALIDAR TOKEN (Cuando el usuario pide datos)
